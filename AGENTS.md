...
| open | Promote exact reviewed linear project-lookup release `8435f7938d9865158975c2a4dbd7e43a3c3bde97`; hosted source gate `32676734390` passed Linux, focused Windows reviewer safety, and the complete Windows matrix; a fresh live preflight must still identify the actual predecessor and no predecessor exception is open | governed rollout pending 2026-08-23 |
