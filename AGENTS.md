...
| note | Auto-apply is ON: non-documentation pushes to `main` trigger a real Phase 1 apply; Markdown-only and `docs/**` pushes are ignored by `apply.yml`. Drift detection runs daily. `cloudflared` token management remains manual (`cloudflared_manage_token: false`). |
| done | 2026-08-21 incident: reviewed successor `d24884fd073081bb2eb43ce6880ba8714fdd6e17` installed; live doctor passed; second tagged run clean; temporary upgrade allowlist emptied | governed rollout completed 2026-08-22 |
| done | Reviewed AI DevOps release `82697a8f07fe50338606c4f4b11d3bbf5e90e1cc` installed by governed dispatch `32624619860`; live doctor passed; exact tagged rerun `32625017742` reported `changed=0`, `unreachable=0`, `failed=0`; temporary upgrade allowlist emptied | governed rollout completed 2026-08-23 |
| done | Final linear memory-index release `3c34bb0785db0a9f1ab548885af279391b196871` installed by governed dispatch `32639239500`; live checkout, owner-only manifest, completion marker, and doctor passed; exact tagged rerun `32639412554` reported `changed=0`, `unreachable=0`, `failed=0`; temporary predecessor exception emptied | governed rollout completed 2026-08-23 |
| done | Exact reviewed release `3e252bcae2b1890a8ca0d00dc11dc0d210e91e0f` installed by governed dispatch `32674373667`; live checkout, manifest, completion marker, doctor, and retired-schedule check passed; exact tagged rerun `32674548896` reported `changed=0`, `unreachable=0`, `failed=0`; no predecessor exception retained | governed rollout completed 2026-08-23 |
| done | Exact reviewed linear project-lookup release `8435f7938d9865158975c2a4dbd7e43a3c3bde97` installed by governed dispatch `32680766203`; live checkout, manifest, completion marker, doctor, and retired-schedule check passed; exact tagged rerun `32680940940` reported `changed=0`, `unreachable=0`, `failed=0`; no predecessor exception was required or retained | governed rollout completed 2026-08-24 |
| done | Preserve evidence of the unexplained production checkout activity after governed release `3e252bcae2b1890a8ca0d00dc11dc0d210e91e0f`: read-only preflight at `2026-08-24T01:43Z` found the checkout clean on `main` at target `8435f7938d9865158975c2a4dbd7e43a3c3bde97`, with the target completion marker absent; the live reflog records an intervening local commit `32fe573` and a `pull --ff-only` to the target at `2026-08-23T20:28:10-04:00`, but no governed Ansible dispatch established that checkout transition | historical evidence preserved; direct non-sudo recurrence contained by `root:ai` `0750` ownership in dispatch `32687426166`; exact idempotent deployments `32689410687` and `32689623813` both reported zero changes |
| done | Preserve evidence of the unexplained production transition from governed release `3c34bb0785db0a9f1ab548885af279391b196871` to `3e252bcae2b1890a8ca0d00dc11dc0d210e91e0f`: read-only preflight at `2026-08-23T23:40Z` found the checkout clean on `main`, the manifest matching, and the completion marker absent; live reflog records `pull --ff-only` at `2026-08-23T18:44:46-04:00`, but no governed Ansible dispatch established the transition | historical evidence preserved; same governed ownership containment verified 2026-08-24 |
| done | Preserve evidence of the unexplained production transition after governed release `82697a8f07fe50338606c4f4b11d3bbf5e90e1cc`: read-only SSH evidence at `2026-08-23T12:16:51Z` captured the checkout and install manifest clean at published ancestor `3fdc87c4502758545373da540b84c77827b49fb0`, with its completion marker absent, but no governed dispatch establishing that transition has been found | historical evidence preserved; same governed ownership containment verified 2026-08-24 |
| done | Preserve evidence of the unexplained production transition after governed release `d24884fd073081bb2eb43ce6880ba8714fdd6e17`: read-only SSH evidence at `2026-08-23T06:23:51Z` captured the checkout and install manifest clean at `d80f468fbf8e7f98c73f9798e0e1de59e2759e01`, but no governed dispatch establishing that transition has been found | historical evidence preserved; same governed ownership containment verified 2026-08-24 |
| open | Identify the actor or automation responsible for the four preserved historical checkout transitions. The direct non-sudo recurrence path is contained, but `ai` retains intentional host-management sudo and the shared `/worksp` parent still permits deliberate directory replacement. | needs trustworthy command provenance, audit logging, or operator evidence; do not infer an actor from Git reflog alone |
